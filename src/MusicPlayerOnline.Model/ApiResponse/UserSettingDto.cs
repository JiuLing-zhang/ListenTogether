namespace MusicPlayerOnline.Model.ApiResponse
{
    public class UserSettingDto
    {
        ...
        /// 常规设置
        /// </summary>
        public GeneralSettingDto General { get; set; } = null!;
        /// <summary>
        /// 平台设置
        /// </summary>
        public SearchSettingDto Search { get; set; } = null!;
        /// <summary>
        /// 播放设置
        /// </summary>
        public PlaySettingDto Play { get; set; } = null!;
    }
